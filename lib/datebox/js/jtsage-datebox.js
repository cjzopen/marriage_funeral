/*
 * JTSage-DateBox
 * For: bootstrap4; With: calbox, flipbox
 * Date: 2018-06-19T01:35:23.114Z
    ...
    $.widget("jtsage.datebox", {
        ...
        _create: function() {
            ...
            var w = this, runTmp, ranTmp, o = $.extend(this.options, this._getLongOptions(this.element), this.element.data("options")), thisTheme = o.theme === false ? "default" : o.theme, d = {
                ...
                mainWrap: $("<div>", {
                    class: "ui-datebox-container pb-4"
                }).css("zIndex", o.zindex),
                intHTML: false
            ...
            if (o.useButton) {
                $("<div class='input-group-append'>" + "<div class='input-group-text' style='border-right:1px solid #dcdcdc;border-radius: 0px 4px 4px 0px;'>" + "<span class='" + o.icnCls + o.buttonIcon + "'></span>" + "</div></div>").attr("title", w.__("tooltip")).on(o.clickEvent, function(e) {
                    e.preventDefault();
                    if (o.useFocus) {
                        w.d.input.focus();
                    } else {
        ...
        open: function() {
            ...
            w.d.mainWrap.empty();
            if (o.useHeader) {
                w.d.mainWrap.append($(w._spf("<div class='{c1}'><h5 class='{c2}'>{text}</h5>" + "<button type='button' class='btn btn-sm btn-secondary closer'>" + "<span class='fa fa-times' aria-hidden='true'></span></button></div>", {
                    c1: "modal-header",
                    c2: "modal-title",
            ...
            if (o.bootstrapDropdown === false && o.bootstrapModal === true) {
                ...
                w.d.modalWrap = $('<div id="jtdb-' + this.uuid + '" class="modal fade">' + '<div class="modal-dialog modal-dialog-centered" role="document">' + '<div class="modal-content">' + "</div></div></div>").addClass(o.useAnimation ? o.transition : "");
